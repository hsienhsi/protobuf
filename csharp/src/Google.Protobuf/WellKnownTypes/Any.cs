...
namespace Google.Protobuf.WellKnownTypes {
  ...
  public static partial class AnyReflection {
    ...
    static AnyReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "ChlHb29nbGUvcHJvdG9idWYvYW55LnByb3RvEg9nb29nbGUucHJvdG9idWYi",
  ...
  ///     }
  /// </summary>
  public sealed partial class Any : pb::IMessage<Any>, pb::IResetObject, pb::IPoolObject
  #if !GOOGLE_PROTOBUF_REFSTRUCT_COMPATIBILITY_MODE
      , pb::IBufferMessage
  #endif
  {
    private static readonly pb::MessagePool<Any> _pool = new pb::MessagePool<Any>(() => new Any(), 30);
    public object AllocateFromPool() { return _pool.Allocate(); }
    public void FreeToPool() { _pool.Free(this); }
    private static readonly pb::MessageParser<Any> _parser = new pb::MessageParser<Any>(() => _pool.Allocate());
    private pb::UnknownFieldSet _unknownFields;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public static pb::MessageParser<Any> Parser { get { return _parser; } }

    public static pb::MessagePool<Any> MessagePool { get { return _pool; } }
